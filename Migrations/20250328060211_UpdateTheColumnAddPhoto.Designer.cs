...
namespace eElection.Migrations
{
    ...
    [Migration("20250328060211_UpdateTheColumnAddPhoto")]
    partial class UpdateTheColumnAddPhoto
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("eElection.Models.Voter", b =>
                {
                    ...
                    b.Property<string>("GovernmentPhotoId")
                        .HasMaxLength(500)
                    ...
                    b.Property<string>("VoterPhotoId")
                        .HasMaxLength(500)
                        .HasColumnType("nvarchar(500)");
